...
import { SolicitarConsultoriaComponent } from './cliente-empresas/solicitar-consultoria/solicitar-consultoria.component';
...
const routes: Routes = [
  ...
  {path:'menu-cliente-empresa/:userId', component: MenuClienteEmpresaComponent},
  {path:'cliente-empresa/solicitar-consultoria', component: SolicitarConsultoriaComponent},
